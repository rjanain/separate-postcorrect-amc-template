...
\def\scoringDefaultS{mz=1}
\def\scoringDefaultM{mz=1}
\def\scoringDefaultN{1}  % for numeric answer no negative marking
\def\scoringDefaultNAPPROX{1}
\def\anynegativemarking{F} % N=No, H=Half, F=Full, Q=Quarter
% ------------ Formula Based Scoring --------------------
%\def\tcqmarks{0.5} 	% Mark for each TFQ
%\def\scqmarks{5}	% Mark for each SCQ
%\def\mcqmarks{1}	% Mark for each MCQ
%\def\scoringDefaultT{formula=(NBC/NB-NMC/NM)*\tcqmarks}
%\def\scoringDefaultS{formula=(NBC/NB-NMC/NM)*\scqmarks}
%\def\scoringDefaultM{formula=(NMC>0 ? 0 : (NBC/NB)*\mcqmarks)}
